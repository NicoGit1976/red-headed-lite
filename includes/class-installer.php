...
class Red_Headed_Installer {
     ...
     * new "red_headed / rh_" namespace. Shared with the Pro edition (same flag +
     * same tables), so whichever edition runs first performs the rename once.
     * Idempotent and only acts when legacy data is actually present.
     */
