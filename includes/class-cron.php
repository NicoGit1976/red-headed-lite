...
class Red_Headed_Cron {
    ...
    public static function register_intervals( $schedules ) {
        $schedules['red_headed_5min']  = array( 'interval' => 5  * MINUTE_IN_SECONDS, 'display' => __( 'Every 5 minutes (Red-Headed)',  'red-headed-lite' ) );
        $schedules['red_headed_15min'] = array( 'interval' => 15 * MINUTE_IN_SECONDS, 'display' => __( 'Every 15 minutes (Red-Headed)', 'red-headed-lite' ) );
        $schedules['red_headed_30min'] = array( 'interval' => 30 * MINUTE_IN_SECONDS, 'display' => __( 'Every 30 minutes (Red-Headed)', 'red-headed-lite' ) );
        if ( ! isset( $schedules['weekly'] ) ) {
            $schedules['weekly'] = array( 'interval' => WEEK_IN_SECONDS, 'display' => __( 'Once a week', 'red-headed-lite' ) );
        }
        return $schedules;
    }
    /**
