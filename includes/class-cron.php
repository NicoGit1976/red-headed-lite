...
class Pelican_Cron {
    ...
    public static function register_intervals( $schedules ) {
        $schedules['pelican_5min']  = array( 'interval' => 5  * MINUTE_IN_SECONDS, 'display' => __( 'Every 5 minutes (Red-Headed)',  'pelican' ) );
        $schedules['pelican_15min'] = array( 'interval' => 15 * MINUTE_IN_SECONDS, 'display' => __( 'Every 15 minutes (Red-Headed)', 'pelican' ) );
        $schedules['pelican_30min'] = array( 'interval' => 30 * MINUTE_IN_SECONDS, 'display' => __( 'Every 30 minutes (Red-Headed)', 'pelican' ) );
        if ( ! isset( $schedules['weekly'] ) ) {
            $schedules['weekly'] = array( 'interval' => WEEK_IN_SECONDS, 'display' => __( 'Once a week', 'pelican' ) );
        }
        return $schedules;
    }
    /**
