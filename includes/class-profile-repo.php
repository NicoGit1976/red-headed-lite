...
class Red_Headed_Profile_Repo {
    ...
    public static function save( $data ) {
        ...
        if ( ! isset( $data['id'] ) || ! $data['id'] ) {
            if ( Red_Headed_Soft_Lock::is_locked( 'profile_unlimited' ) ) {
                ...
                if ( $count >= 1 ) {
                    return new \WP_Error( 'lite_limit', __( 'Lite is capped to 1 export profile. Upgrade to Pro for unlimited profiles.', 'red-headed-lite' ) );
                }
            }
        }
        /* v1.4.53 — Secret-preservation. The editor blanks secret fields (SFTP
     ...
     * to the stored ones by type, in submission order. v1.4.53.
     *
